...
export function makeSettingsButtonHtml() {
  const svg = `
    <svg width="16" height="16" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="funda-neighbourhoods-configure-badge">
  ...
  const configureBadgesBadge = `
    <li
      class="funda-neighbourhoods-badge fd-border-radius fd-m-right-2xs fd-p-horizontal-xs"
